<template>
    <div class="quality-container route-padd">
        ...
        <div class="bar-spec-container">
            <div class="bar-head">
                <h2>PURITY SPECIFICATION LIMITS FOR  BARS</h2>
        ...
        <div class="bar-spec-container">
            <div class="bar-head">
                <h2>MELTING POINTS & DENSITIES OF ELEMENTS</h2>
            </div>
            <table>
                <tr>
                    <th>Element</th>
...
let source1 = ref("src/Assets/ALLOYDOWNFORMULA.pdf")
</script>